...
export type IceAgeScenarioConfig = {
   ...
   * so put elev-gated specials (high montane → ice) before the
   * fallback (low montane → tundra) in the array.
   */
 ...
 */
export const ICE_AGE_TRANSITIONS: readonly BiomeTransitionRule[] = [
