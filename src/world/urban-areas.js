 ...
 * only a centre tier.
 */
export function outermostTier(rec) {
 ...
 */
function shrinkPolygon(polygon, centroidLat, centroidLon, factor) {
 ...
 */
export function mockTiersFromLegacyPolygon(legacy) {
 ...
 */
export function legacyToTieredRecord(legacy) {
    return {
        id: legacy.id,
        lat: legacy.lat,
        lon: legacy.lon,
