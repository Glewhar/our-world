 ...
 */
import { buildPrngStreams } from '../prng.js';
import { DynamicGrid } from '../fields/grid.js';
import { decayStep, DEFAULT_DECAY } from '../fields/diffusion.js';
...
export class Scheduler {
    ...
    advance(deltaMs) {
        ...
        if (this.fieldAccumMs > MAX_CATCHUP_MS)
            this.fieldAccumMs = MAX_CATCHUP_MS;
        if (this.worldAccumMs > MAX_CATCHUP_MS)
            this.worldAccumMs = MAX_CATCHUP_MS;
