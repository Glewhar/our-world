...
export function mountActiveEvents(popoverHost, registry, totalDaysProvider) {
    ...
    function toggle() { popoverHost.hidden = !popoverHost.hidden; }
    function hide() { popoverHost.hidden = true; }
    function dispose() {
        popoverHost.replaceChildren();
        rowsById.clear();
    }
