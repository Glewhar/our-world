...
export class PostFXChain {
    ...
    constructor(renderer, scene, camera) {
        ...
        const target = new THREE.WebGLRenderTarget(Math.max(1, Math.floor(size.x * pixelRatio)), Math.max(1, Math.floor(size.y * pixelRatio)), { samples: 0, type: THREE.UnsignedByteType });
