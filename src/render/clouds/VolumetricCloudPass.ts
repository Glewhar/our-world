...
export class VolumetricCloudPass {
  ...
  setSootFrame(
    ...
    sunTint: { r: number; g: number; b: number },
    ambientTint: { r: number; g: number; b: number },
  ): void {
    ...
    (this.cloudMaterial.uniforms.uSootSunTint!.value as THREE.Color).setRGB(
      sunTint.r, sunTint.g, sunTint.b,
    );
    (this.cloudMaterial.uniforms.uSootAmbientTint!.value as THREE.Color).setRGB(
      ambientTint.r, ambientTint.g, ambientTint.b,
    );
  }
