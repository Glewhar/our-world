...
export class RouteScaffoldLayer {
  ...
  constructor(data: AirplaneData) {
    ...
    this.geometry.setAttribute(
      'aSrcDst',
      new THREE.InstancedBufferAttribute(aSrcDst, 4),
    );
    this.geometry.setAttribute(
      'aTMin',
      new THREE.InstancedBufferAttribute(aTMin, 1),
    );
    this.geometry.setAttribute(
      'aTMax',
      new THREE.InstancedBufferAttribute(aTMax, 1),
    );
    this.geometry.setAttribute(
      'aAlpha',
      new THREE.InstancedBufferAttribute(aAlpha, 1),
    );
