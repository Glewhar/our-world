...
export type UrbanDetailUniforms = {
  ...
  // Buildings palette (read by BUILDINGS_FRAG; unused but harmless on the
  // streets material — it shares the uniform shape).
  uBuildingBaseLow: { value: THREE.Color };
  uBuildingBaseHigh: { value: THREE.Color };
  uBuildingNightDark: { value: THREE.Color };
  uBuildingNightLitWarm: { value: THREE.Color };

  // Streets palette (read by STREETS_FRAG).
  uStreetDayDark: { value: THREE.Color };
  uStreetDayLight: { value: THREE.Color };
  uStreetNightDark: { value: THREE.Color };
  uStreetNightLit: { value: THREE.Color };
