 ...
 */
export function buildPolygonAtlas(records) {
    const projected = [];
    let totalVerts = 0;
    ...
    const texture = new THREE.DataTexture(data, ATLAS_WIDTH, height, THREE.RGFormat, THREE.FloatType);
 ...
 */
export function pointInPolygon(polyXy, x, y) {
    let inside = false;
