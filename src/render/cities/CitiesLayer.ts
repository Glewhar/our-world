...
import type { CityRecord, WorldRuntime } from '../../world/index.js';
...
export type CitiesUniforms = {
  ...
  uMaxRadiusKm: { value: number };
  uBaseRadiusKm: { value: number };
  uMinRadiusKm: { value: number };
  uMinPopulation: { value: number };

  uFalloffStrength: { value: number };
...
export class CitiesLayer {
  ...
  constructor(world: WorldRuntime, cities: readonly CityRecord[]) {
