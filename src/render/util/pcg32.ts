...
export class Pcg32 {
  ...
  constructor(seed: number, stream: number = 0xa3c59ac3) {
    ...
    if ((this.stateLo >>> 0) < (seed >>> 0)) this.stateHi = (this.stateHi + 1) >>> 0;
    this.next();
  }
