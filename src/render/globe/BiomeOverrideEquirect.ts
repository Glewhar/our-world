...
export class BiomeOverrideEquirect {
  ...
  private cachedClassVersion = -1;
  private cachedStampVersion = -1;

  private overrideClassTex: THREE.DataTexture | null = null;
  private overrideStampTex: THREE.DataTexture | null = null;
