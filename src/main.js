...
import { GlobalWarmingScenario, IceAgeScenario, InfraDecayScenario, NuclearScenario, NuclearWarScenario, RebuildingScenario, ScenarioRegistry, } from './world/scenarios/index.js';
...
async function boot() {
    ...
    console.info(`[autotune] tier=${autoTierName} avgFrameMs=${probe.avgFrameMs.toFixed(2)} ` +
